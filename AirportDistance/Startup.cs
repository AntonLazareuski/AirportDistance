...
using AirportDistance.Repository;
...
namespace AirportDistance
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<IAirportClient, AirportClient>();
            services.Configure<AirportApiOptions>(Configuration.GetSection(AirportApiOptions.Section));
        }
